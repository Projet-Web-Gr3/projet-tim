...
function _4w4_joules_enqueue_style()
{
    ...
    $version_part = filemtime(get_template_directory() . '/js/particles.js');
    ...
    wp_enqueue_script('particules', get_template_directory_uri() . '/js/particles.js', array(), $version_part, true);
}
